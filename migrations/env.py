[12:26 PM, 3/23/2025] Chandu shree V: import os
...
DATABASE_URL = os.getenv("DATABASE_URL", "postgresql+asyncpg://postgres:ChandushreeV@localhost:5433/document_db")
...
[12:27 PM, 3/23/2025] Chandu shree V: from fastapi import FastAPI
...
[12:28 PM, 3/23/2025] Chandu shree V: from logging.config import fileConfig
